const restaurants = [
  {
      ...
      menuLink: "https://qrifycafetria2.netlify.app/"
  },
  {
      id: "restaurant-2",
      name: "KFC",
      ...
      menuLink: "https://qrifykfc.netlify.app/"
  },
  {
      id: "restaurant-3",
      name: "Tons Food Park",
      ...
      menuLink: "https://example.com/tons-food-menu"
  },
  {
      id: "restaurant-4",
      name: "Yours Bawarchi",
      ...
      rating: "⭐⭐⭐⭐",
      description: "Every Bite Is A Masterpiece!",
      menuLink: "https://example.com/bawarchi-menu"
  },
  {
      id: "restaurant-5",
      name: "MOM's KITCHEN",
      ...
      menuLink: "https://example.com/moms-kitchen-menu"
  },
  {
      id: "restaurant-6",
      name: "Doon Darbar",
      ...
      menuLink: "https://example.com/doon-darbar-menu"
  }
];
...
function displayRestaurants() {
  ...
  restaurants.forEach(restaurant => {
      ...
      card.innerHTML = `
          ...
          <a href="${restaurant.menuLink}" target="_blank">
